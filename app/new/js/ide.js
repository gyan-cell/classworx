const API_KEY = "f5902e9deamshbb54c4e4b6e4e4cp1787f6jsnb8a094598fdf"; // Get yours for free at https://judge0.com/ce and https://judge0.com/extra-ce
...
function run() {
    ...
    if (parseInt(languageId) === 82) {
        if (sqliteAdditionalFiles === "") {
            ...
            $.ajax({
                url: `https://newstudy.salientdevs.com/new/data/additional_files_zip_base64.txt`,
                type: "GET",
                async: true,
